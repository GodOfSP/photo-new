    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources()
                    .getDrawable(R.mipmap.delete_search_out_daohanglan);
        }
        int width = DensityUtil.dip2px( context,24);
        mClearDrawable.setBounds(-DensityUtil.dip2px( context,10), 0, width -DensityUtil.dip2px( context,10), width);
