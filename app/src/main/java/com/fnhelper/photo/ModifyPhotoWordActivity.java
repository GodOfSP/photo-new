 ...
 * 编辑图文
 */
public class ModifyPhotoWordActivity extends BaseActivity implements View.OnClickListener, MarkNormalDelegate.onNormalItemThings, MarkMarkDelegate.onNormalItemThings {
    ...
    private void initMarkList() {
        ...
        markRv.setLayoutManager(new LinearLayoutManager(ModifyPhotoWordActivity.this, LinearLayoutManager.VERTICAL, false));
        markList = new ArrayList<>();
        marKListAdapter = new MultiItemTypeAdapter(ModifyPhotoWordActivity.this, markList);
    ...
    private void initPhotoList() {
        FullyGridLayoutManager manager = new FullyGridLayoutManager(ModifyPhotoWordActivity.this, 3, GridLayoutManager.VERTICAL, false);
        recycler.setLayoutManager(manager);
        adapter = new GridImageAdapter(ModifyPhotoWordActivity.this, onAddPicClickListener);
                ...
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(ModifyPhotoWordActivity.this).themeStyle(R.style.picture_QQ_style).openExternalPreview(position, selectList);
                            break;
                        case 2:
                            // 预览视频
                        ...
                        case 3:
                            // 预览音频
                            PictureSelector.create(ModifyPhotoWordActivity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
    ...
    private void initMarkPop(final int type, boolean isOpen) {
        ...
        mMarkPop = EasyPopup.create()
                .setContentView(ModifyPhotoWordActivity.this, R.layout.fill_mark_pop)
        ...
        if (type == MARK_TYPE_ALL) {
            ...
            if (isAllDone == 6) {
                showBottom(ModifyPhotoWordActivity.this, "已添加所有备注项，可左滑编辑每一项");
                return;
            }
    ...
    private void initChooseMediaPop() {
        ...
        mCirclePop = EasyPopup.create()
                .setContentView(ModifyPhotoWordActivity.this, R.layout.choose_media_type_pop)
                .setAnimationStyle(R.style.BottomPopAnim)
                //是否允许点击PopupWindow之外的地方消失
                .setFocusAndOutsideEnable(false)
                .setWidth(ViewGroup.LayoutParams.MATCH_PARENT)
    ...
    private void clearCash() {
        ...
        permissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE).subscribe(new Observer<Boolean>() {
            ...
            public void onNext(Boolean aBoolean) {
                if (aBoolean) {
                    PictureFileUtils.deleteCacheDirFile(ModifyPhotoWordActivity.this);
                } else {
                    Toast.makeText(ModifyPhotoWordActivity.this,
    ...
    private void choosePhoto() {
        ...
        PictureSelector.create(ModifyPhotoWordActivity.this)
...
/*        public static final int MARK_TYPE_GOOD_NUM = 601; //货号备注
        ...
        call.enqueue(new Callback<CheckCodeBean>() {
            ...
            public void onFailure(Call<CheckCodeBean> call, Throwable t) {
                loadingDialog.dismiss();
                showBottom(ModifyPhotoWordActivity.this, "网络可能有问题！");
            }
        });
