...
public class WXShareMultiImageService extends AccessibilityService {
    ...
    private static final String CONTACTS_ZH = "通讯录";
    private static final String CONTACTS_EH = "Contacts";
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        switch (event.getEventType()) {
            case AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED:
                switch (event.getClassName().toString()) {
                    case LAUNCHER_UI:
                        ...
                        openDiscover(event);
                        break;
                        case WECHAT_CLASS_CONTACTINFOUI:
                        currentUI = WECHAT_CLASS_CONTACTINFOUI;
                        openDiscover(event);
                        break;
            ...
            case AccessibilityEvent.TYPE_VIEW_FOCUSED:
                if (currentUI.equals(LAUNCHER_UI)||currentUI.equals(WECHAT_CLASS_CONTACTINFOUI)) {
                    if (event.getClassName().toString().equals(ListView.class.getName())) {
                        openDiscover(event);
                    }
                }
