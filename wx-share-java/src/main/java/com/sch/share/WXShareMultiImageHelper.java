...
public class WXShareMultiImageHelper {
     ...
     */
    public static void shareToSession(Activity activity, List<Uri> imageList) {
     ...
     * @param text      分享文本。
     */
    public static void shareToSession(final Activity activity, final List<Uri> imageList, final String text) {
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (checkShareEnable(activity)) {
                    ...
                    openShareUI(activity, text, imageList, SHARE_IMG_UI);
                }
            }
        });
    }
     ...
     * @param imageList 图片列表。
     */
    public static void shareToTimeline(Activity activity, List<Uri> imageList) {
     ...
     * @param text      分享文本。
     */
    public static void shareToTimeline(Activity activity, List<Uri> imageList, String text) {
     ...
     */
    public static void shareToTimeline(Activity activity, List<Uri> imageList, boolean isAuto) {
     ...
     * @param isAuto    是否由 SDK 自动粘贴文字、选择选图。
     */
    public static void shareToTimeline(final Activity activity, final List<Uri> imageList, final String text, final boolean isAuto) {
        activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
